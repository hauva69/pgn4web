...
case "$1" in
  ...
  "live-games-app" ) pgn4webPackageFileList="$pgn4webBaseFiles dynamic-frame.html fide-lookup.js fonts/index.html fonts/chess-informant-NAG-symbols.js fonts/pgn4web-font-ChessInformantReader.css fonts/ChessInformantReader.* images/index.html images/alpha/index.html images/alpha/96/* libs/README.txt libs/index.html libs/garbochess/* engine.* live-games-app* pawn+.png";;
